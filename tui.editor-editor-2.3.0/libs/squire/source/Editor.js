...
proto.setConfig = function(config) {
    config = mergeObjects({
        ...
        sanitizeToDOMFragment: typeof DOMPurify !== 'undefined' && DOMPurify.isSupported ?
...
proto.setHTML = function(html) {
    ...
    if (!config.preserveStructure && !config.preserveWhitespace) {
